...
pub fn spawn_capture(
    ...
    std::thread::Builder::new()
        .name("mortar-pestle-capture".into())
        .spawn(move || {
            pw::init();
        ...
        .expect("spawn mortar-pestle-capture thread")
}
...
fn handle_save_replay(
    ...
    std::thread::Builder::new()
        .name("mortar-pestle-capture-save".into())
        .spawn(move || {
        ...
        .expect("spawn mortar-pestle-capture-save thread");
}
