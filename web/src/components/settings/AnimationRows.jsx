...
const ROWS = [
  ...
  { key: 'pulse-indicators',       label: 'Pulse indicators',        description: 'Active-pill left-bar pulse, "new" badge pulse, brand-pill vault-sync glow, sidebar-row drop pulse, conflict-toast spring.' },
